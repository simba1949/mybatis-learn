...
/**
 * @author anthony
 * @version 2023/11/8 15:43
 */
@Slf4j
public class UserDO4ResultMapMapperTest {
    private static SqlSession sqlSession;
    private static UserDO4ResultMapMapper userDO4ResultMapMapper;
    ...
    public static void init() throws IOException {
        ...
        userDO4ResultMapMapper = sqlSession.getMapper(UserDO4ResultMapMapper.class);
    }
